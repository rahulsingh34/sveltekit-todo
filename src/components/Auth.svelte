...
<form on:submit|preventDefault={handleLogin}>
    <div class='flex flex-col text-sm mb-2'>
        ...
        <input class="appearance-none shadow-sm border
        border-gray-200 p-2 mb-2 focus:outline-none focus:border-gray-500"
        placeholder="Add your email" name="email" type="email"
        bind:value={email}>
        <button type="submit"
        class="w-full shadow-sm rounded bg-blue-500 hover:bg-blue-600
        text-white py-2 px-4">Log In</button>
    </div>
</form>