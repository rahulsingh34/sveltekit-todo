...
<li class="bg-white flex items-center shadow-sm border
border-gray-200 rounded-lg my-2 py-2 px-4">
    ...
    ${todo.completed ? 'line-through' : ''}`}">{todo.text}</span>

    <button type="button" class="text-sm bg-red-500 hover:bg-red-600
